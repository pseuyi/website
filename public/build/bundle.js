    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			a = element("a");
    			img = element("img");
    			attr_dev(img, "alt", "recurse center logo");
    			attr_dev(img, "width", "32px");
    			if (img.src !== (img_src_value = "https://webring.recurse.com/icon.png")) attr_dev(img, "src", img_src_value);
    			add_location(img, file$3, 0, 38, 38);
    			attr_dev(a, "href", "https://webring.recurse.com");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 13, 2, 261);
    			attr_dev(h2, "class", "svelte-1qrcxhe");
    			add_location(h2, file$4, 15, 2, 335);
    			attr_dev(main, "class", "svelte-1qrcxhe");
    			add_location(main, file$4, 12, 0, 252);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
